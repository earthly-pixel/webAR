import { j0 as zr, ig as gr, j1 as je, a5 as Lr, iA as It, iX as tu, iY as mr, iZ as eu, i_ as ru, iW as nu, iv as uu, eX as iu, i$ as Er } from "./decode-US8u_7WO.js";
import { createCanvas as ou } from "canvas";
class Fr {
  constructor(e, r, u) {
    this.cumsum = [];
    for (let n = 0; n < u; n++) {
